  ...
  return (
    <div className={styles.notFound}> {/* Main container for the NotFound component */}
      ...
      <p className={styles.notFound__error}> {/* Display the error message from the error object if available. */}
        {error?.statusText || error?.message}  //displays either statusText or message from error object. uses optional chaining (?.) to safely access properties in case error is null or undefined
      </p>
